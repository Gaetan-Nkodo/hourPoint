...
@Component({
  ...
  templateUrl: './dashboardUserAdmin.component.html',
  styleUrls: ['./dashboardUserAdmin.component.css'],
  providers:[]
})
export class DashboardUserAdminComponent implements OnInit, AfterViewInit {
  ...
  // constructor(private navbarTitleService: NavbarTitleService) { }
    ...
    subscribeToPromise(){
      ...
      //*
      this.data2.getAdminWeekHoursInfo(this.data2.getUserIdFromLocalStorage()).subscribe(
        res => {
            this.tab =res;
      ...
      //*
      this.data2.getAdminMonthHoursInfo(this.data2.getUserIdFromLocalStorage(),this.selectedMonth+1,this.selectedYear).subscribe(
        res => {
            this.tab2 =res;

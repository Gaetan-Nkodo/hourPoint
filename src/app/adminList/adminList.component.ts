...
export class AdminListComponent implements OnInit {
  constructor(private data2:GlobalService,private http:HttpClient,private status:HTTPStatus ) { }
  ...
  refrechUserList(){
    ...
    this.data2.getInfo().subscribe(res=>{
                                          this.tab=res
                                          this.status.setHttpStatus(false);

                                          console.log("val2",this.tab);


                                     }); 

    this.userPayload = this.data2.getUserPayload();
  }
  ...
  deleteUser(_id:string){
    ...
    var bool: BehaviorSubject<boolean> = new BehaviorSubject(false);
  ...
  bool.subscribe((value)=>{
    console.log(value);
     if (true === value) {
      ...
      this.data2.DeleteUser(_id).subscribe(
          res => {
            console.log(res);
            this.refrechUserList();
            swal({
  ...
  seeUserProfil(_id){
    console.log("seeUserProfil",_id);
    this.data2.setUserIdToLocalStorage(_id);
  }

  seeUserHourInfo(_id){
    console.log("seeUserHourInfo",_id);
    this.data2.setUserIdToLocalStorage(_id);
  }
